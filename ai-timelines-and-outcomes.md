...
**Version 1.22 — 17 September 2026**
...
**Plant and site infrastructure is a serial dependency in its own right.** Cleanroom qualification, ultrapure water commissioning, gas system certification and HVAC balancing all happen *after* construction and *before* production, and none of them parallelizes with what it depends on. For a leading-edge fab this is not ancillary: cleanroom air handling is among the largest energy loads in the plant even before accounting for the tighter, localized ISO Class 1 environments scanners require, temperature must hold to fractions of a degree because thermal drift moves lithographic alignment, and water consumption runs to millions of gallons a day with treatment facilities that are substantial plants themselves.
